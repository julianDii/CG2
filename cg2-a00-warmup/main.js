...
function makePath (arg1){
    ...
    var pathStringObj = "";
        ...
        return function (path) {
            if (path) {
                if (arg1) {
                    if (pathStringObj) pathStringObj = pathStringObj + arg1 + path;
                    else pathStringObj = path;
                }
                else  {
                    if (pathStringObj) pathStringObj = pathStringObj + "/" + path;
                    else pathStringObj = path;
                }
            }
            return pathStringObj;
        };
